...
const getProductsService = async (id) => {
    ...
    // console.log("allProducts", allProducts,"allUsers", allUsers, "allOrders", allOrders)
    const productsInformationArray = allProducts.map(product => {
        let productInformation= {
            ...
            const filteredUserOrders = allOrders.filter(order => {
                ...
                // console.log("type of user._id", typeof(user._id.toString()), "type of order.UserID", typeof(order.UserID))
            ...
            // console.log("filteredUserOrders", filteredUserOrders)
